    ...
    <div class="container mx-auto max-w-7xl p-4 sm:p-6 lg:p-8">
        <div class="flex flex-col md:flex-row md:gap-x-8">
            ...
            <main class="w-full md:w-2/3 lg:w-3/4">
                ...
                @if (auth()->check() && $user->id == auth()->id())
                    <!-- My Orders Section -->
                    <section id="orders" class="bg-white p-0 sm:p-0 rounded-xl shadow-md mb-8">
                        <button id="toggle-orders" type="button" class="w-full flex items-center justify-between px-6 py-4 sm:px-8 bg-lime-50 rounded-t-xl focus:outline-none">
                        ...
                        <div id="orders-content" class="px-6 sm:px-8 pb-6" style="display: {{ $orders->isEmpty() ? 'none' : 'block' }};">
                            @if($orders->isEmpty())
